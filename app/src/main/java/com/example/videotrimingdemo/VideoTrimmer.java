package com.example.videotrimingdemo;
...
import com.example.videotrimingdemo.interfaces.VideoTrimmerListener;
import com.example.videotrimingdemo.interfaces.OnProgressVideoListener;
import com.example.videotrimingdemo.interfaces.OnRangeSeekBarListener;
import com.example.videotrimingdemo.interfaces.OnTrimVideoListener;
import com.example.videotrimingdemo.utils.BackgroundExecutor;
import com.example.videotrimingdemo.utils.TrimVideoUtils;
import com.example.videotrimingdemo.utils.UiThreadExecutor;
import com.example.videotrimingdemo.views.ProgressBarView;
import com.example.videotrimingdemo.views.RangeSeekBarView;
import com.example.videotrimingdemo.views.Thumb;
import com.example.videotrimingdemo.views.TimeLineView;
...
import static com.example.videotrimingdemo.utils.TrimVideoUtils.stringForTime;
...
public class VideoTrimmer extends FrameLayout {
    ...
    private VideoTrimmerListener mVideoTrimmerListener;
    ...
    private void onVideoPrepared(@NonNull MediaPlayer mp) {
        ...
        if (mVideoTrimmerListener != null) {
            mVideoTrimmerListener.onVideoPrepared();
        }
    }
     ...
     *
     * @param videoTrimmerListener interface for events
     */
    @SuppressWarnings("unused")
    public void setOnK4LVideoListener(VideoTrimmerListener videoTrimmerListener) {
